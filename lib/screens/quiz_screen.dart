...
//   // const QuizScreen({Key? key, required this.subtopicId}) : super(key: key);
//   final int topicId;
//   const QuizScreen({Key? key, required this.subtopicId, required this.topicId}) : super(key: key);
//   @override
...
//   }
//
//   void _submitAnswer(QuizQuestion question) async {
...
//
//       if (correct) {
//         // Show success and navigate back or to completion screen
//         // showDialog(
//         //   context: context,
//         //   builder: (_) => AlertDialog(
//         //     title: Icon(Icons.check_circle, color: Colors.green, size: 48),
//         //     content: Text('Correct! Subtopic completed.'),
//         //     actions: [
//         //       TextButton(
//         //         onPressed: () {
//         //           Navigator.pop(context); // close dialog
//         //           Navigator.pop(context); // back to subtopics or notes
//         //         },
//         //         child: Text('OK'),
//         //       ),
//         //     ],
...
//             ),
//             content: Text(
//               correct ? 'Correct! Subtopic completed.' : 'Wrong answer.',
...
//                   if (correct) {
//                     // Pop twice: QuizScreen -> NotesScreen -> SubtopicsScreen
//                     Navigator.pop(context); // close quiz
//                     Navigator.pop(context); // close notes, now at subtopics
//                   } else {
//                     setState(() => _isSubmitting = false); // allow retry
//                   }
//                 },
//                 child: const Text('OK'),
//               ),
...
//         );
//         setState(() {
//           _selectedOptionId = null; // allow retry
//           _isSubmitting = false;
//         });
//       }
//     } catch (e) {
...
//                 ),
//                 SizedBox(height: 20),
//                 Text('Choose your answer:', style: TextStyle(fontSize: 16)),
//                 SizedBox(height: 10),
//                 // Options
//                 Expanded(
...
//                             color: _selectedOptionId == option.optionId
//                                 ? Color(0xFF5F9DF2).withOpacity(0.2)
//                                 : Colors.white,
//                             border: Border.all(
//                               color: _selectedOptionId == option.optionId
//                                   ? Color(0xFF5F9DF2)
...
//                     backgroundColor: Color(0xFF5F9DF2),
