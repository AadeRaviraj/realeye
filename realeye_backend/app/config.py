...
# #  AI Chat  + Database config
# ASTRA_DB_TOKEN = os.getenv("ASTRA_DB_TOKEN")
# ASTRA_DB_KEYSPACE = os.getenv("ASTRA_DB_KEYSPACE", "realeye")
# ASTRA_DB_BUNDLE_PATH = os.getenv("ASTRA_DB_BUNDLE_PATH", "realeye_backend/realeye_token.zip")
